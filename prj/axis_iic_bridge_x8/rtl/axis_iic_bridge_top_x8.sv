...
module axis_iic_bridge_top_x8 (
    ...
    logic                    s_axis_tready;
    //
    logic [(DATA_WIDTH-1):0] i_s_axis_tdata ;
    logic [(KEEP_WIDTH-1):0] i_s_axis_tkeep ;
    ...
    //
    logic [(DATA_WIDTH-1):0] o_m_axis_tdata ;
    logic [(KEEP_WIDTH-1):0] o_m_axis_tkeep ;
    ...
    axis_fifo_pkt axis_fifo_pkt_inst (
        ...
        .s_axis_tkeep (4'hF               ),   // input wire [0 : 0] s_axis_tkeep
