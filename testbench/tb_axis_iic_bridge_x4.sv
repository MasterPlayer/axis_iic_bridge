...
module tb_axis_iic_bridge_x4 ();
    ...
    always_ff @(posedge clk) begin : s_axis_processing 
        case (index) 
                ...
                2000 : begin s_axis_tdata <= 32'h00000001; s_axis_tuser <= 8'hA6; s_axis_tkeep <= 1'b1; s_axis_tvalid <= 1'b1; s_axis_tlast <= 1'b0; end 
                2001 : begin s_axis_tdata <= 32'h00000081; s_axis_tuser <= 8'hA6; s_axis_tkeep <= 1'b1; s_axis_tvalid <= 1'b1; s_axis_tlast <= 1'b1; end 
               
               20000 : begin s_axis_tdata <= 32'h00000039; s_axis_tuser <= 8'hA7; s_axis_tkeep <= 1'b1; s_axis_tvalid <= 1'b1; s_axis_tlast <= 1'b1; end 
